            ...
            >
                <div style={{ display: "flex", height: "75%", width: "100%" }}>
                    ...
                    >
                        ...
                        >
                            <img src={flowers} alt="flowers" style={{ width: "60%", transform: "scaleX(-1)" }} />
                        </div>
                    </div>
                    ...
                    >
                        <div
                            style={{
                                ...
                                display: "flex",
                                // justifyContent: "center",
                                backgroundImage: `url(${gender === "Ladies" ? ladiesDress : suits})`,
                                backgroundSize: "cover",
                                backgroundPosition: "center",
                                backgroundRepeat: "no-repeat",
                                borderRadius: "40%",
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <p style={{ padding: "10px 30px", fontSize: "30px" }}>
                                    Think bright and beautiful. Let your outfit reflect the warmth and color of spring.
                                </p>
                            </div>
                            <div
                                style={{
